		...
		<div align="center">
			<h3>
				...
				<%
					...
					String title = request.getParameter("FMenuName");
			...
			<tr>
				<th align="left">
					<a href="information!showMenuToNews.action?FMenuName=<%=title %>"
								class="LINK1" ><img
			...
			<hr>
			<div align="center">
				<form action="information!addInformation.action" method="post"
					...
					<table width="80%" border="1" cellspacing="0">
						<tr height="20">
							...
							<td colspan="2">
								...
								<input type="hidden" name="info.FInfoType" value="<%=title%>" />
