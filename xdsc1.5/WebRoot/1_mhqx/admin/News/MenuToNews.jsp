...
<html>
	...
	<body>
		...
		<div align="center">
       <form action="information!deleteAllNews.action"
							method="post">
			<table border="0" id="mytable" width="700">
				...
				<s:iterator value="menuInfoList" status="status">
					<tr>
                     ...
                     <s:if test="newsflag[#status.index]==1" >
					   <a href="<%//=request.getContextPath()%>/1_mhqx/admin/Newspictures/NewspicturesAdd.jsp?FInfoId=<s:property value="FInfoId"/>">
					              图片新闻设置</a></s:if>
					 <s:if test="newsflag[#status.index]==0" >
					   <a href="<%//=request.getContextPath()%>/1_mhqx/admin/Newspictures/NewspicturesUpdate.jsp?FInfoId=<s:property value="FInfoId"/>">
					              图片新闻更新</a></s:if>
		             </td>
		             -->
						<td align="center">
			...
			<table width="700">
				<tr>
					...
					<td width="26%" align="right">
						<a href="<%=request.getContextPath()%>/information!showMenuToNews.action?p=1">首页</a>
					</td>
					<td width="6%" align="center">
						<a href="<%=request.getContextPath()%>/information!showMenuToNews.action?p=${p-1}">上一页</a>
					</td>
					<td width="6%" align="center">
						<a href="<%=request.getContextPath()%>/information!showMenuToNews.action?p=${p+1}">下一页</a>
					</td>
					<td align="left">
						<a href="<%=request.getContextPath()%>/information!showMenuToNews.action?p=${lastPage}">末页</a>
					</td>
					<td align="left">
					       共${lastPage }页
					</td>
