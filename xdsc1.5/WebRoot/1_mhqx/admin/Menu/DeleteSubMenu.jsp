			...
			<table border="0" width="700">
				...
				<tr align="center">
					<td width=100% align="center">
						...
						<br><br>
							<s:iterator value="MenuToBeDeletelist" status="sl">
							<a href="HTMenu!deleteSubMenu.action?dmid=<s:property value="FMenuId" />" style="color:royalblue;" onclick="return conf()"><s:property value="FMenuName" /></a><br><br>
							</s:iterator>
