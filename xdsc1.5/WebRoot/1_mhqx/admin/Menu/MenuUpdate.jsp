...
body {
	...
	<body>
		...
		<div align="center">
			...
			<hr>
			<div align="center">
				<form action="menu!menuUpdate.action?FMenuId=<s:property value="menu_pre.FMenuId"/>" method="post"
						...
						<tr height="20">
							...
							<td colspan="2">
								<input type="text" name="FMenuName"
									value="<s:property value="menu_pre.FMenuName"/>" size="25%" />
							</td>
						</tr>
						<tr>
						<th width="15%">
							...
							<td colspan="2">
								<input type="text" name="FMenuPriority"
									value="<s:property value="menu_pre.FMenuPriority"/>" size="10%" />
							</td>
						</tr>
						<tr>
						<th width="15%">
							...
							<td colspan="2">
								<input type="text" name="FSuperMenuId"
									value="<s:property value="menu_pre.FSuperMenuId"/>" size="10%" />
							</td>
						</tr>
							...
							<td>
								...
								<s:iterator value="firstList" status="fl">
									...
									<a
										...
										class="" target="right"> <s:property value="FMenuName" />
										<br> </a>
									<span id="content_detail_${fl.index}"
										...
										<s:iterator value="subList[#fl.index]" status="sl">
											<s:if test="thirdList[#fl.index][#sl.index].size()>0">
												<span id="show_content_${sl.index+30}" style="cursor: hand;"
