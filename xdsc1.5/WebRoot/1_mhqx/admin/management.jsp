...
window.setInterval('reinitIframe()', 200);
	...
	<body>
		<div align="center">
			<iframe id="top" name="top" width="100%" height="190px" src="top.jsp"
				...
				<tr>
					<td>
						<iframe id="left" name="left" width="195px" height="620"
							src="left_management.jsp" scrolling="NO" frameborder="0"
					...
					<td width="80%" valign="top">
						<iframe id="right" name="right" width="100%" height="620"
							src="welcome_page.jsp" scrolling="NO" frameborder="0"
							style="border-style: none;"></iframe>
					</td>
				</tr>
			</table>
