...
-->
	...
	<body>
		...
		<hr>
		<br>
		<s:form theme="simple" action="" name="f" method="post">
		<table width="80%" border="0" id="mytable" align="center">
			...
			<tr>
				<td colspan="2" align="center">
					<input type="button" value="返回" onClick="javascript:document.f.action='student/HomeworkManage!findHomeNoticeInfo.action';document.f.submit();" />
				</td>
			</tr>
		</table>
		</s:form>
