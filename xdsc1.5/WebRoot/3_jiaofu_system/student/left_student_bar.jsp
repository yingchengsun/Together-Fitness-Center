			...
			<div class="PI_main" style="height: auto">
				...
				<div style="position: relative;">
					...
					<div id="PARENT">
						<ul id="nav">
							<li>
								<a href="student/CourseManage!findCourseInfo.action" target="right">查看课程</a>
							</li>
							<li>
								<a href="student/CourseManage!findCourseNoticeInfo.action" target="right">课程通知</a>
							</li>
							<li>
								<a href="student/CourseManage!questionReplyInfo.action" target="right">课程答疑</a>
							</li>
						</ul>
					</div>
					...
					<div id="PARENT">
						<ul id="nav">
							<li>
								<a href="student/Teachingmanage!findAllInfo.action" target="right">自我安排</a>
							</li>
						</ul>
					</div>
					...
					<div id="PARENT">
						<ul id="nav">
							<li>
								<a href="student/HomeworkManage!findHomeNoticeInfo.action" target="right">查看作业</a>
							</li>
							<li>
								<a href="student/HomeworkManage!findHomeUploadInfo.action" target="right">提交作业</a>
							</li>
						</ul>
					</div>
					<div style="width: 160px; height: 5px; background: white;"></div>
					...
					<div id="PARENT">
						<ul id="nav">
							<li>
								<a href="student/ResourceManage!findResourceInfo.action" target="right">
									查看资源</a>
							</li>
						</ul>
					</div>
