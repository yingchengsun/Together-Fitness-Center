...
-->
	...
	<body>
		...
		<hr>
		<br>   
		<s:form action="administrator/corresponding!addTeacherDeploy.action" method="post" theme="simple">
		<table width="50%" border="0" id="mytable" align="center">
			...
			<tr>
				...
				<td width="" bgcolor="3D99A5" align="center">
					<s:updownselect list="listClassesInfo" name="listSelectClassesInfo" listKey="FClassNumber" listValue="FClassName"
					       headerKey="-1" headerValue="---请选择班级(多选)---" emptyOption="false" multiple="true"
					       size="12">
					</s:updownselect>
				</td>
			</tr>
