...
-->
	...
	<body>
		...
		<hr>
		<br>   
		<s:form action="administrator/corresponding!addStudentDeploy.action" method="post" theme="simple">
			...
			<tr>
				...
				<td width="" bgcolor="3D99A5" align="center">
					<s:updownselect list="listCourseInfo" name="listSelectCourseInfo" listKey="FCourseNumber" listValue="FCourseName"
					       headerKey="-1" headerValue="---请选择课程(多选)---" emptyOption="false" multiple="true"
					       size="12">
					</s:updownselect>
				</td>
			</tr>
