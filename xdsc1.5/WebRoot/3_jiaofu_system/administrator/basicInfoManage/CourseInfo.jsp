...
-->
	...
	<body>
		...
		<hr>
			<s:form action="administrator/BasicInfo!findCourseInfoByName.action" method="post" theme="simple">
				<table width="80%" border="0" align="center">
					<tr>
						<td align="left">
							查询课程名称:
							<s:textfield name="FCourseNameselect" />
							&nbsp;
							<s:submit value="提交" />
						</td>
						<td align="right">
							<a href="3_jiaofu_system/administrator/basicInfoManage/CourseInfoAdd.jsp">添加新课程信息</a>
						</td>
					</tr>
				</table>
			</s:form>
			<form action="administrator/excelIn5.action" enctype="multipart/form-data" method="post">
			<table width="80%" border="0" align="center">
			  <tr>
			    <td align="left">
					     导入excel文件<input type="file" name="file" />&nbsp;<input type="submit" value="导入" />
					     <img src="3_jiaofu_system/pictures/excel.bmp">文件格式要求为：序号、课程编号、课程名称、学分、学时、备注
				</td>
			  </tr>
			</table>
			</form>
		<table width="80%" border="0" id="mytable" align="center">
			...
			<s:iterator value="listCourseInfo" status="status">
				   <tr>
				     ...
				     <td align="center"><s:property value="FCourseNumber"/></td>
				     <td align="center"><s:property value="FCourseName"/></td>
				     <td align="center"><s:property value="FCourseScore"/></td>
				     <td align="center"><s:property value="FCourseXueShi"/></td>
				     <td align="center"><s:property value="FRemark"/></td>
				     <td align="center">
			...
			<tr align="center">
			  <td colspan="8">
			           <a href='<s:url action="administrator/BasicInfo!findCourseInfo.action"> <s:param name="p" value="1"></s:param></s:url>'>首页</a>
				       <a href='<s:url action="administrator/BasicInfo!findCourseInfo.action"> <s:param name="p" value="%{p-1}"></s:param></s:url>'>上一页</a>
                       <a href='<s:url action="administrator/BasicInfo!findCourseInfo.action"> <s:param name="p" value="%{p+1}"></s:param></s:url>'>下一页</a>
                       <a href='<s:url action="administrator/BasicInfo!findCourseInfo.action"> <s:param name="p" value="lastPage"></s:param></s:url>'>最后</a>
		...
		<table border="0" style="border-collapse: collapse" align="center">
				<tr>
					...
					<th>
						<img src="3_jiaofu_system/pictures/jfnow.png"><a href="administrator/BasicInfo!findCourseInfo.action">管理基本课程信息</a>
					</th>
					<td>
