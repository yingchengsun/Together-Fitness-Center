...
<script type="text/javascript">
	...
	<body>
		...
		<s:form action="administrator/ScoreInfo!deletelist1.action" method="post" theme="simple">
		<table width="80%" border="0" id="mytable" align="center">
			...
			<s:iterator value="listUsualscoreInfo" status="status">
				<tr>
					...
					<td align="center">
					    <input type="checkbox" name="deletelist1" value="${FNumber}"/>
					</td>
				</tr>
			</s:iterator>
			...
			<tr align="center">
			    <td colspan="9">
			      <a href='<s:url action="administrator/ScoreInfo!findUsualScore.action"> <s:param name="p" value="1"></s:param></s:url>'>首页</a>
			      <a href='<s:url action="administrator/ScoreInfo!findUsualScore.action"> <s:param name="p" value="%{p-1}"></s:param></s:url>'>上一页</a>
                  <a href='<s:url action="administrator/ScoreInfo!findUsualScore.action"> <s:param name="p" value="%{p+1}"></s:param></s:url>'>下一页</a>
                  <a href='<s:url action="administrator/ScoreInfo!findUsualScore.action"> <s:param name="p" value="lastPage"></s:param></s:url>'>最后</a>
