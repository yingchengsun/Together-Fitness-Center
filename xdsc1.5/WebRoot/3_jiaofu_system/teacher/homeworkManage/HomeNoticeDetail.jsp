	...
	<body>
		...
		<table width="80%" border="0" id="mytable" align="center">
			...
			<tr>
				...
				<td align="center">
				   <s:property value="jfptTabHomenotice.FContent"/>
				</td>
			</tr>
			<tr>
				<td align="center">
				...
				<td align="center">
				   ...
				   <s:else>
				      <a href="teacher/HomeworkManage!downFile.action?FHomeNoticeId=<s:property value="jfptTabHomenotice.FHomeNoticeId"/>"> 点击下载</a>
				   </s:else>
				</td>
			</tr>
			<tr>
