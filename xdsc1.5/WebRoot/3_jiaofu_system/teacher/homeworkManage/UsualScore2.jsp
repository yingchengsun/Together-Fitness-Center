...
-->
	...
	<body>
		...
		<table width="80%" border="0" id="mytable" align="center">
			...
			<s:iterator value="listUsualscoreInfo" status="status">
				<tr>
					...
					<td align="center">
						<a href="teacher/HomeworkManage!deleteUsualscoreInfoByID.action?FNumber=<s:property value="FNumber"/>">点击删除</a>
					</td>
				</tr>
			</s:iterator>
			...
			<tr align="center">
			   <td colspan="9">
			           <a href='<s:url action="teacher/HomeworkManage!findUsualSelectInfo.action"> <s:param name="p" value="1"></s:param></s:url>'>首页</a>
				       <a href='<s:url action="teacher/HomeworkManage!findUsualSelectInfo.action"> <s:param name="p" value="%{p-1}"></s:param></s:url>'>上一页</a>
                       <a href='<s:url action="teacher/HomeworkManage!findUsualSelectInfo.action"> <s:param name="p" value="%{p+1}"></s:param></s:url>'>下一页</a>
                       <a href='<s:url action="teacher/HomeworkManage!findUsualSelectInfo.action"> <s:param name="p" value="lastPage"></s:param></s:url>'>最后</a>
		...
		<table width="80%" border="0" id="mytable" align="center">
		  <s:if test="listUsualscoreInfo.size > 0">
		     <tr align="center">
		        <td><a href="teacher/HomeworkManage!updateStudentsScore.action">进行平时成绩汇总</a><img src="3_jiaofu_system/pictures/go.gif"></td>
		        <td><a href="teacher/HomeworkManage!webChartBefore.action">查看平时成绩分布图</a><img src="3_jiaofu_system/pictures/go.gif"></td>
		     </tr>
		  </s:if>
		</table>
	</body>
