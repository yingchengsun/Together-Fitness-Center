		...
		<table width="80%" border="0" id="mytable" align="center">
			...
			<s:iterator value="listHomeuploadInfo" status="status">
				<tr>
					...
					<td align="center">
						<a href="teacher/HomeworkManage!findHomeworkDetailByID.action?FHomeId=<s:property value="FHomeId"/>">点击查看</a>
					</td>
				</tr>
			</s:iterator>
			...
			<tr align="center">
			   <td colspan="7">
			           <a href='<s:url action="teacher/HomeworkManage!findSelectHomeworkInfo.action"> <s:param name="p" value="1"></s:param></s:url>'>首页</a>
				       <a href='<s:url action="teacher/HomeworkManage!findSelectHomeworkInfo.action"> <s:param name="p" value="%{p-1}"></s:param></s:url>'>上一页</a>
                       <a href='<s:url action="teacher/HomeworkManage!findSelectHomeworkInfo.action"> <s:param name="p" value="%{p+1}"></s:param></s:url>'>下一页</a>
                       <a href='<s:url action="teacher/HomeworkManage!findSelectHomeworkInfo.action"> <s:param name="p" value="lastPage"></s:param></s:url>'>最后</a>
