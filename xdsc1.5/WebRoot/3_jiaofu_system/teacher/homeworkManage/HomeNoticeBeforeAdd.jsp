...
-->
	...
	<body>
		...
		<tr>
			   ...
			   <tr align="center">
			     <td align="left">
			       <s:iterator value="listClassNumberInfo" status="status">
						...
						<img src="3_jiaofu_system/pictures/jfmessage.gif" onclick="javascript:document.f.action='teacher/HomeworkManage!AddNewHomenoticeBefore2.action?DirectionNumber=0&ClassNumber=<s:property/>';document.f.submit();">
						&nbsp;|&nbsp;
			   ...
			   <tr align="center">
			     <td align="left">
			       <s:iterator value="listDirectionInfo" status="status">
						...
						<img src="3_jiaofu_system/pictures/jfmessage.gif" onclick="javascript:document.f.action='teacher/HomeworkManage!AddNewHomenoticeBefore2.action?ClassNumber=0&DirectionNumber=<s:property value="FDirectionId"/>';document.f.submit();">
						&nbsp;|&nbsp;
						<s:if test="#status.count % 4 ==0">
			       	       <br>
			       	   </s:if>
            ...
            <s:if test="listStudentsInfo.size > 0">
			   <tr align="center">
			      <td align="left">全部学生<img src="3_jiaofu_system/pictures/jfmessage.gif" onclick="javascript:document.f.action='teacher/HomeworkManage!AddNewHomenoticeBefore2.action?ClassNumber=0&DirectionNumber=0';document.f.submit();"></td>
			   </tr>
			</s:if>
			<s:else>
			   <tr><td align="left">无可用信息!</td></tr>
			</s:else>
		</table>
		</s:form>
	</body>
