	...
	<body>
		...
		<table width="80%" border="0" id="mytable" align="center">
			...
			<tr>
				...
				<s:else>
				<td align="center">
					<s:textarea name="FReply"  value="%{jfptTabHomeupload.FReply}" cols="100%" disabled="true" rows="5"/>
				</td>
				</s:else>
			</tr>
			<tr>
				<td colspan="2" align="center">
				    <s:if test="jfptTabHomeupload.FReply == null || jfptTabHomeupload.FReply.equals('')">
				       <input type="submit" value="更新" onClick="javascript:document.f.action='teacher/HomeworkManage!updateHomeworkInfoByID.action';document.f.submit();" />&nbsp;
				       <input type="reset" value="重置 ">&nbsp;
				    </s:if>
					<input type="button" value="返回" onClick="javascript:document.f.action='teacher/HomeworkManage!findSelectHomeworkInfo.action';document.f.submit();" />
				</td>
			</tr>
		</table>
		</s:form>
