		...
		<table width="80%" border="0" id="mytable" align="center">
			...
			<s:iterator value="listCourseInfo" status="status">
				<tr>
					...
					<td align="center">
					    <a class="LINK21" href="#" onclick='dialog(&quot;班级方向信息&quot;,&quot;url:get?<%=basePath%>teacher/CourseManage!seeCourseDetail.action?FCourseNumber=<s:property value="FCourseNumber" />&quot;,&quot;370px&quot;,&quot;auto&quot;,&quot;id&quot;); '>查看详细</a>
					</td>
				</tr>
			</s:iterator>
			...
			<tr align="center">
			   <td colspan="7">
			           <a href='<s:url action="teacher/CourseManage!findCourseInfo.action"> <s:param name="p" value="1"></s:param></s:url>'>首页</a>
				       <a href='<s:url action="teacher/CourseManage!findCourseInfo.action"> <s:param name="p" value="%{p-1}"></s:param></s:url>'>上一页</a>
                       <a href='<s:url action="teacher/CourseManage!findCourseInfo.action"> <s:param name="p" value="%{p+1}"></s:param></s:url>'>下一页</a>
                       <a href='<s:url action="teacher/CourseManage!findCourseInfo.action"> <s:param name="p" value="lastPage"></s:param></s:url>'>最后</a>
