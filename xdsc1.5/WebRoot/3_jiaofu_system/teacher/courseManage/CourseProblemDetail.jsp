			...
			<table width="80%" border="0" id="mytable" align="center">
				...
				<tr>
			        <td colspan="2" align="center">
                       <input type="button" value="提交" onclick="javascript:document.f.action='teacher/CourseManage!addReplyInfoByID.action?FQuestionId=<s:property value="jfptTabCourseaskquestion.FQuestionId"/>';document.f.submit();"/>
                        &nbsp;<s:reset value="重置"/>&nbsp;
