...
-->
	...
	<body>
		...
		<table width="80%" border="0" id="mytable" align="center">
			   ...
			   <tr align="center">
			     <td align="left">
			       <s:iterator value="listClassNumberInfo" status="status">
						...
						<img src="3_jiaofu_system/pictures/jfsee.png" onclick="javascript:document.f.action='assist/HomeworkManage!webChart.action?DirectionNumber=0&ClassNumber=<s:property/>';document.f.submit();">
						&nbsp;|&nbsp;
			   ...
			   <tr align="center">
			     <td align="left">
			       <s:iterator value="listDirectionInfo" status="status">
						...
						<img src="3_jiaofu_system/pictures/jfsee.png" onclick="javascript:document.f.action='assist/HomeworkManage!webChart.action?ClassNumber=0&DirectionNumber=<s:property value="FDirectionId"/>';document.f.submit();">
						&nbsp;|&nbsp;
						<s:if test="#status.count % 4 ==0">
			       	       <br>
			       	   </s:if>
			...
			<tr align="center">
			  <td align="left">全部学生<img src="3_jiaofu_system/pictures/jfsee.png" onclick="javascript:document.f.action='assist/HomeworkManage!webChart.action?ClassNumber=0&DirectionNumber=0';document.f.submit();"></td>
			</tr>
		</table>
		</s:form>
	</body>
