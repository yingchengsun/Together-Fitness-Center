  ...
  var name=$(this).text(); //获取返回的NAME
	...
	<body>
	   <br /><br /><br />
		...
		<legend>
		  <font size="2" >功能管理</font>
		</legend>
		<s:form name="showbysystem" action="FunctionAction!showfunctionlist2.action" method="post" theme="simple">
			<table>
				<tr>
		...
		<br>
		<s:form name="listform" action="FunctionAction!multipledelete.action" method="post">
     <table border="1" id="mytable" style="border-collapse:collapse" width="98%">
        ...
        <tr>
          ...
          <td align="center"><a href='<s:url action="FunctionAction!modifyfunction"><s:param name="id" value="FFunctionId"></s:param></s:url>'>修改</a></td>
          <td align="center"><a href='<s:url action="FunctionAction!deletefunction"><s:param name="id" value="FFunctionId"></s:param></s:url>'>删除</a></td>
        ...
        <tr>
          <td colspan="7" align="center">
              <center>
                <a href='<s:url action="FunctionAction!showfunctionlist"> <s:param name="p" value="1"></s:param></s:url>'>首页</a>
                <a href='<s:url action="FunctionAction!showfunctionlist"> <s:param name="p" value="%{p-1}"></s:param></s:url>'>上一页</a>
                <a href='<s:url action="FunctionAction!showfunctionlist"> <s:param name="p" value="%{p+1}"></s:param></s:url>'>下一页</a>
                <a href='<s:url action="FunctionAction!showfunctionlist"> <s:param name="p" value="lastPage"></s:param></s:url>'>最后</a>
