...
body {
	...
	<body>
		...
		<hr>
		<div align="center">
			<form action="appUp!adUD.action" enctype="multipart/form-data"
				method="post">
				
							<s:select name="FType" list="listFTypeInfo" headerKey=""
								headerValue="==选择更改项==" />
				<br>
				<s:select name="Number" list="list" headerKey=""
				headerValue="==选择被修改者系统帐号==" />
				<table border="1" width="61.8%" id="mytable">
					<tr>
