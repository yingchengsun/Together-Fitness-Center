...
<html>
	...
	oCalendarChs.Init();
		...
		<hr>
		<div align="center">
			<form action="adAllCheck!updateNotice.action" method="post">
				<table width="700" border="1" id="mytable">
					...
					<tr>
						...
						<td>
							<input type="text" value="<s:property value="tabNotice.FInfoTitle"/>"name="FInfoTitle">
						</td>
					</tr>
					<tr>
						<td>
						...
						<td>
							<input size="50" type="text" value="<s:property value="tabNotice.FInfoContet" />" name="FInfoContet" >
						</td>
					</tr>
					<tr>
						<td>
