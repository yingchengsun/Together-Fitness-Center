...
body {
	...
	<body>
		...
		<div align="center">
			<table width="61.8%">
				...
				<tr>
					...
					<td>
						<div align="left">
							请您填写您的邮箱地址，您的系统帐号将是您登陆系统的用户名，请您牢记
						</div>
					</td>
				</tr>
				<tr>
		...
		<div align="center">
			<hr>
			<form action="apreg!getvalue1.action" method="post">
				<table border="1" width="51.8%" id="mytable"
					...
					<tr>
						<th background="<%=basePath%>images/4_Pictures/newmenubg.gif" colspan="2" height="20">
							<font color="#FFFFFF">表1/4：基本信息</font>
						</th>
					</tr>
					<TR>
						<TD align="center" width="38.2%">
							*姓名
						</TD>
						<TD>
							<div align="center">
								<input name="AppRegName" maxlength="10" />
							</div>
						</TD>
					</TR>
					...
					<TR>
						...
						<TD>
							<div align="center">
								<input readonly="readonly" type="text" name="AppRegBirthday"
					...
					<TR>
						<TD align="center">
							<SPAN class=staralt>*</SPAN>籍贯
						</TD>
						<TD>
							<div align="center">
								<select name="AppRegHomeTown">
									<option value=""></option>
									<option value="北京市">
										北京市
									</option>
					...
					<TR>
						...
						<TD>
							<div align="center">
								<input type="text" name="AppRegIdCard" maxlength="18" value="">
							</div>
						</TD>
					</TR>
					...
					<TR>
						...
						<TD>
							<div align="center">
								<input type="text" name="UserNumber" maxlength="16">
							</div>
						</TD>
					</TR>
					<TR>
