...
<html>
	...
	<br>
		...
		<hr>
		<div align="center">
		<form action="getFStudentListByStiOption.action">
				<table>
					<tr>
						<th>
							历史查询：
		...
		<div align="center">
		<form action="getFStudentListByStipend.action">
			<table border="0" width="700" id="mytable">
				<tr>
					<th colspan="8" background="<%=request.getContextPath() %>/2_xsgl_system/Pictures/newmenubg.gif" height="30">
						<font color="#FFFFFF">助学金信息列表</font>
					</th>
				</tr>
				<tr>
				    <th>
		...
		<table width="40%">
				<tr>
					<td>
						<div align="center">
							<a href="stiStuPrevious.action">上一页</a>
						</div>
					</td>
					<td>
						<div align="center">
							<a href="stiStuNext.action">下一页</a>
						</div>
					</td>
					<td>
