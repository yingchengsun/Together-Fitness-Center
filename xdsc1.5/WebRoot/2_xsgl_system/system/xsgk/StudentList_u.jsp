...
<html>
	...
	<body>
		...
		<hr>
		<div align="center">
		<form action="getGradeListByUndergraduate.action">
			<table border="0" width="700" id="mytable">
				<tr>
					<th colspan="7" background="<%=request.getContextPath() %>/2_xsgl_system/Pictures/newmenubg.gif"
						height="30">
						<font color="#FFFFFF">软件学院本科生信息</font>
					</th>
				</tr>
				<tr>
					<th>
				...
				<c:forEach items="${gradeList }" var="grade">
					...
					<td>
						<a href="<%=request.getContextPath() %>/getUndergraduateListByGrade.action?gid=${grade.FGradeId }"><img src="<%=request.getContextPath() %>/2_xsgl_system/Pictures/userinfo.gif"
