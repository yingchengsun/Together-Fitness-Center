...
<html>
	...
	<body>
		...
		<h3 align="center" > 
			软件学院学生会信息</h3><hr>
		<div align="center">
		<form action="getSStudentByDepartment.action">
				<table>
					<tr>
						<th>
							快速查找：
		...
		<hr>
		<div align="center">
		<form action="getStudentBySStudentUnion.action">
			<table border="0" width="700" id="mytable">
				<tr>
					<th colspan="5" background="<%=request.getContextPath() %>/2_xsgl_system/Pictures/newmenubg.gif" height="30">
						<font color="#FFFFFF">软件学院学生会成员名单</font>
					</th>
				</tr>
				<tr>
					<th>
			...
			<table width="40%">
				<tr>
					<td>
						<div align="center">
							<a href="stuUnStuPrevious.action">上一页</a>
						</div>
					</td>
					<td>
						<div align="center">
							<a href="stuUnStuNext.action">下一页</a>
						</div>
					</td>
					<td>
