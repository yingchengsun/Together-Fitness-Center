...
<html>
	...
	<body>
		...
		<hr>
		<div align="center">
		<form action="getSStudentByTWDepartment.action">
				<table>
					<tr>
						<th>
							快速查找：
		...
		<form action="getStudentByTuanWei.action">
			<table border="0" width="700" id="mytable">
				<tr>
					<th colspan="6" background="<%=request.getContextPath() %>/2_xsgl_system/Pictures/newmenubg.gif" height="30">
			...
			<table width="40%">
				<tr>
					<td>
						<div align="center">
							<a href="tuanweiStuPrevious.action">上一页</a>
						</div>
					</td>
					<td>
						<div align="center">
							<a href="tuanweiStuNext.action">下一页</a>
						</div>
					</td>
					<td>
