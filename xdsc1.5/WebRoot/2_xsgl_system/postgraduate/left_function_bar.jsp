				...
				<div>
					<div class="PI_main" style="height: 500px">
						<div style="position: relative;top: 5%;">
							...
							<div id="PARENT">
								<ul id="nav">
									<li><a href="../system/grxx/Archives.jsp/showStudentArchives.action?id=0881490001" target="right">个人档案</a></li>	
									<li><a href="../system/grxx/Basic_p.jsp/showPostgraduate.action?id=0881490001" target="right">在校信息</a></li>
								</ul>
							</div>
							<div style="
								width:160px;
							...
							<div id="PARENT">
								<ul id="nav">
									<li><a href="../system/bjgz/Party_s.jsp/getSGradeStudentByPartyList.action?regdate=2006" target="right">学生党建</a></li>
									<li><a href="../system/bjgz/Attendance_s.jsp" target="right">学生考勤</a></li>
								</ul>
							</div>
							<div style="
								width:160px;
							...
							<div id="PARENT">
								<ul id="nav">
									<li><a href="../system/zz/Ss_s.jsp/getGradeStudentListByLoan.action?regdate=2006" target="right">助学贷款</a></li>
									<li><a href="../system/zz/Ss2_s.jsp/getGradeStudentListByStipend.action?regdate=2006" target="right">助学金</a></li>
									<li><a href="../system/zz/Ss3_s.jsp/getGradeStudentListByScholarship.action?regdate=2006" target="right">奖学金</a></li>
								</ul>
							</div>
							<div style="
								width:160px;
