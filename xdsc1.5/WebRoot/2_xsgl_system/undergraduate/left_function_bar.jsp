				...
				<div>
					<div class="PI_main" style="height: 500px">
						<div style="position: relative;top: 5%;">
							...
							<div id="PARENT">
								<ul id="nav">
									<li><a href="../system/grxx/Archives.jsp/showStudentArchives.action?id=13061012" target="right">个人档案</a></li>	
									<li><a href="../system/grxx/Basic_u.jsp/showUndergraduate.action?id=13061012" target="right">在校信息</a></li>
								</ul>
							</div>
							<div style="
								width:160px;
