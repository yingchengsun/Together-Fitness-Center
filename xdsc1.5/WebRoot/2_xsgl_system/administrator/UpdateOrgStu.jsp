...
<html>
 <head>
  ...
  <body>
		...
		<hr>
		<div align="center">
		 <form action="<%=request.getContextPath()%>/updateOrgStu.action"
			method="post">
				<table border="1" width="700">
					...
					<tr>
						<td>
							学号：
							<input type="hidden" name="fid" value="${student.FId }">
						</td>
						<td>
							<input type="text" name="FStudentNumber"
							value="${student.tabStudents.FStudentNumber }">
						</td>
					</tr>
					<tr>
						<td>
						...
						<td>
							...
							value="${student.xsglTabDepartment.FDid  }">
						</td>
					</tr>
					<tr>
						<td>
						...
						<td>
							<input type="text" name="FPosition"
							value="${student.FPosition }">
						</td>
					</tr>
				<tr>
					<td>
