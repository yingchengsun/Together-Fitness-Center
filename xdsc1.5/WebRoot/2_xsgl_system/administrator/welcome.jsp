...
window.setInterval('reinitIframe()', 200);
	...
	<body>
	<div align="center">
		<iframe id="top" name="top" width="100%" height="165px" src="<%=basePath %>2_xsgl_system/top.jsp"
			...
			<tr>
				<td>
					<iframe id="left" name="left" width="195px" height="620"
						src="<%=basePath %>2_xsgl_system/administrator/left_function_bar.jsp" scrolling="NO" frameborder="0"
						style="border-style: none; display: block"></iframe>
				</td>
				<td width="2%" valign="top">
					<iframe id="middleFrame" name="middleFrame" width="100%"
						height="620" src="<%=basePath %>2_xsgl_system/administrator/middleFrame.jsp" scrolling="NO" frameborder="0"
						style="border-style: none;"></iframe>
				</td>
				<td width="80%" valign="top">
					<iframe id="right" name="right" width="100%" height="620"
						src="<%=basePath %>2_xsgl_system/administrator/Homepage.jsp" scrolling="NO" frameborder="0"
						style="border-style: none;"></iframe>
				</td>
			</tr>
		</table>
