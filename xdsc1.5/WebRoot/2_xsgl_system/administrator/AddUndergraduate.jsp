...
<html>
 <head>
  ...
  <body>
		...
		<hr>
		<div align="center">
		 <form action="<%=request.getContextPath()%>/saveUndergraduate.action"
			method="post">
				<table border="1" width="700">
					...
					<tr>
						...
						<td>
							...
							value="${undergraduate.FStudentExSchool }">
						</td>
					</tr>
					<tr>
						<td>
						...
						<td>
							...
							value="${undergraduate.FStudentEscore }">
						</td>
					</tr>
					<tr>
						<td>
						...
						<td>
							...
							value="${undergraduate.FStudentErank }">
						</td>
					</tr>
					<tr>
						<td>
