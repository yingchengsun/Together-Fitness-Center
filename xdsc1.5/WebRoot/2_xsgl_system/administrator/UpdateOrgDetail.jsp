...
<html>
 <head>
  ...
  <body>
		...
		<hr>
		<div align="center">
		 <form action="<%=request.getContextPath()%>/updateOrganization.action"
			method="post">
				<table border="1" width="700">
					...
					<tr>
						<td>
							组织编号：
							<input type="hidden" name="oid" value=${organization.FOid }>
						</td>
						<td>
							<input type="text" name="FOid"
							value="${organization.FOid }">
						</td>
					</tr>
					<tr>
						<td>
