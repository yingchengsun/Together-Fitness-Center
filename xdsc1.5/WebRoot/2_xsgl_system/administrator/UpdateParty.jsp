...
<html>
 <head>
  ...
  <body>
		...
		<hr>
		<div align="center">
		 <form action="<%=request.getContextPath()%>/updateParty.action"
			method="post">
				<table border="1" width="700">
					...
					<tr>
						<td>
							班级：
							<input type="hidden" name="partyID" value=${party.FId }>
						</td>
						<td>
							<input type="text" name="FClassNumber"
							value="${party.tabClasses.FClassNumber }">
						</td>
					</tr>
					<tr>
						<td>
					...
					<tr>
						...
						<td>
							<input type="text" name="FMaleNum"
							value="${party.FMaleNum }">
						</td>
					</tr>
					<tr>
						<td>
						...
						<td>
							<input type="text" name="FFemaleNum"
							value="${party.FFemaleNum }">
						</td>
					</tr>
