...
<html>
 <head>
  ...
  <body>
		...
		<hr>
		<div align="center">
		 <form action="<%=request.getContextPath()%>/updateDepartment.action"
			method="post">
				<table border="1" width="700">
					...
					<tr>
						...
						<td>
							...
							value="${department.xsglTabOrganizations.FOid }">
						</td>
					</tr>
					<tr>
						<td>
						...
						<td>
							...
							value="${department.xsglTabOrganizations.FOname }">
						</td>
					</tr>
					<tr>
						<td>
