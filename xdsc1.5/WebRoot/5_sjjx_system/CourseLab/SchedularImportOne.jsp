...
<html>
	...
	oCalendarChs.Init();
		...
		<br>
		<h3 align="center">实验安排信息编辑</h3>
		<table align="center" width="700">
			<tr>
				<th align="left"><a href="5_sjjx_system/CourseLab/SchedularImport.jsp"><img src="5_sjjx_system/Pictures/return.gif" align="top" border="0"/>返回</a></th>
			</tr>
		</table> 
		<hr>
		<div align="center">
				...
				<table border="1" width="700">
					<tr>
						<th height="30" colspan="2" align="center" background="5_sjjx_system/Pictures/newmenubg.gif">
							<font color="#FFFFFF">填&nbsp;写&nbsp;信&nbsp;息（*为必填）</font>
						</th>
					</tr>
					<tr>
						<td>
