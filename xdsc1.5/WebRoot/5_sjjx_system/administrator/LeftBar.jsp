			...
			<div>
					<div class="PI_main" style="height: 500px">
						<div style="position: relative;top: 5%;">
							...
							<div class="fun_list" id="fun_list1" onclick="javasrcipt:showfun(2)">
								<label > 实验室管理 </label>
							</div>
							<div id="PARENT">
								<ul id="nav">
									
									<li><a href="showLab.action" target="right">管理实验室</a></li>
									<li><a href="showAllCourseLab.action" target="right">安排实验</a></li>
								</ul>
							</div>
							<div style="
								width:160px;
							...
							<div class="fun_list" id="fun_list3" onclick="javasrcipt:showfun(3)">
								<label ><a href="showInfoList.action" target="right"> 发布通知</a></label>
							</div>
							<div style="
								width:160px;
								height: 5px;
