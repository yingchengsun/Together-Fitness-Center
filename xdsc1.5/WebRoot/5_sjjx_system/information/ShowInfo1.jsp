	...
	<body>
		...
		<c:when test="${isempty=='1'}">
		    ...
		    <table align="center" width="700">
			   <tr>
				  <th align="center">
					<a href="5_sjjx_system/information/AddInformation1.jsp">添加新通知公告</a>
			   </tr>
		    </table>
			<br/>
		</c:when>
		...
		<table align="center" width="700">
			<tr>
				<th align="right">
					<a href="5_sjjx_system/information/AddInformation1.jsp">添加新通知公告 
					</a>
				</th>
			</tr>
		</table>
		...
		<div align="center">
			...
			<table border="0" width="700" id="mytable">
				...
				<tr>
					...
					<td>
					  <a href="showTZGGInfoDetail.action?infoId=${tzggInfo.FInfoId }">查看</a>
					</td>
				</tr>
				</c:forEach>
			</table>
			<table width="40%">
				<tr>
					<td>
						<div align="center">
							<a href="previousI1.action">上一页</a>
						</div>
					</td>
					<td>
						<div align="center">
							<a href="nextI1.action">下一页</a>
						</div>
					</td>
					<td>
