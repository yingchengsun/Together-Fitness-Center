...
<html>
	...
	<body>
		...
		<hr>
		<s:form action="admin/Tongji!findClassoneByNum.action" method="post" theme="simple">
		...
		<div align="center">
			...
			<table border="0" id="mytable" width="700">
				<tr>
					<th align="center" colspan="10" background="<%=basePath%>Pictures/newmenubg.gif" height="30">
				...
				<s:iterator value="listClassInfo" status="status">
				   <tr>
					...
					<td align="center">
				        <a href="admin/Tongji!updateClassInfo.action?FClassNumber=<s:property value="FClassNumber"/>">
				                          修改
				        </a>
				     </td>
				    
				     <td align="center">
				        <a href="admin/Tongji!delClassByNum.action?FClassNumber=<s:property value="FClassNumber"/>"> 删除</a>
				     </td> 
				   </tr>
			</s:iterator>
