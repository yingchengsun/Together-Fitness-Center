...
<html>
	...
	<body>
		...
		<hr>
		<s:form action="admin/Workyear!updateWorkyear.action" method="post" theme="simple">
			<table border="0" id="mytable" width="700">
			
				<tr>
               		<td align="center">编号</td>
               		<td>
                 		<input type="text" value="<s:property value="workyear.FId"/>" name="FId" disabled="disabled">
               		</td>
             	</tr>
             	<tr>
               <td align="center">公司</td>
               <td>
                 <input name="FCompanyName" type="text" value="<s:property value="workyear.TabCompany.FCompanyName"/>">
               </td>
             </tr>
             <tr>
               <td align="center">招聘年份</td>
               <td>
                 <input type="text" value="<s:property value="workyear.FComNumYear"/>" name="FComNumYear">
               </td>
             </tr>
             <tr>
               <td align="center">招聘人数</td>
               <td>
                 <input type="text" value="<s:property value="workyear.FComNum"/>" name="FComNum">
               </td>
             </tr>
