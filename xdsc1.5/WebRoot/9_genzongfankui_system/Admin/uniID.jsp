...
<html>
	...
	<body>
		...
		<table align="center" width="700">
			<tr>
				<th align="left"><a href="<%=basePath%>9_genzongfankui_system/Admin/addKaoyan.jsp"><img src="<%=basePath%>Pictures/return.gif" align="top" border="0"/>返回</a></th>
			</tr>
		</table> 
		<div align="center">
  	...
  	<tr>
		<td><div align="center"><a href="<%=basePath %>admin2/UniInfo!findAllUniInfo.action?p=1" >首页</a></div></td>
		<td><div align="center"><a href="<%=basePath %>admin2/UniInfo!findAllUniInfo.action?p=${p-1}" >上一页</a></div></td>
		<td><div align="center"><a href="<%=basePath %>admin2/UniInfo!findAllUniInfo.action?p=${p+1}" >下一页</a></div></td>
		<td><div align="center"><a href="<%=basePath %>admin2/UniInfo!findAllUniInfo.action?p=${lastPage}" >末页</a></div></td>
	</tr>
  </table>
		<br>
		<br>
