...
<html>
	...
	<body>
		<br>
		<h3 align="center"><img src="<%=basePath%>Pictures/submittutorial_001.png" align="top" border="0" width="50" height="50"/>添加公司录用信息</h3>
		...
		<hr>
		<div align="center">
			<form action="admin/Workyear!addWorkyear.action" method="post">
				<table border="1" width="700">
					<tr>
						<th height="30" colspan="2" align="center" background="<%=basePath%>Pictures/newmenubg.gif">
							<font color="#FFFFFF">公司录用信息</font>
						</th>
					</tr>
					<tr>
						<td>
						...
						<td><div align="left">
							<input type="text" name="FCompanyNumber"  /><a href="<%=basePath%>admin3/CompanyInfo!findAllCompanyInfo.action">
					...
					<tr>
						...
						<td>
							<div align="left">
		         <input readonly="readonly" type="text" name="FComNumYear"
						...
						<td><div align="left">
							<input type="text" name="FContactPerson"  />
						</div></td>
					</tr>
