...
<html>
	...
	<body>
		...
		<h3 align="center">对不起，该学生就业记录已存在</h3>
		<table align="center" width="700">
			<tr>
				<th align="center"><a href="<%=basePath%>9_genzongfankui_system/Admin/addWork.jsp"  ><img src="<%=basePath%>Pictures/return.gif" align="top" border="0"/>返回添加页面</a></th>
			</tr>
		</table>
