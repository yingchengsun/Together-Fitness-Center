...
<html>
	...
	<body>
		<br>
		<h3 align="center">添加毕业去向统计信息</h3>
		<table align="center" width="700">
			<tr>
				<th align="left"><a href="<%=basePath%>admin/Tongji!findAllClassInfo.action"><img src="<%=basePath%>Pictures/return.gif" align="top" border="0"/>返回</a></th>
			</tr>
		</table> 
		<hr>
		<div align="center">
			<form action="admin/Tongji!updateClassInfo.action" method="post">
				<table border="1" width="700">
					<tr>
						<th height="30" colspan="2" align="center" background="<%=basePath%>Pictures/newmenubg.gif">
							<font color="#FFFFFF">软件学院班级去向信息</font>
						</th>
					</tr>
					<tr>
						<td>
