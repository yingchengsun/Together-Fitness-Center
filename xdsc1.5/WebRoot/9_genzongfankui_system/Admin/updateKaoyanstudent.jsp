...
<html>
	...
	<body>
		...
		<br>
		<h3 align="center">
			<img src="<%=basePath%>Pictures/sketchy_paper_001.png" align="top" border="0" width="50" height="50"/>修改深造学生信息
		</h3>
		<hr>
		<s:form action="admin/KaoyanInfo!updateKaoyanInfo.action" method="post" theme="simple">
			<table border="0" id="mytable" width="700">
			
				<tr>
               		<td align="center">编号</td>
               		<td>
                 		<input type="text" value="<s:property value="kaoyanStudent.FNumber"/>" name="FNumber" disabled="disabled">
               		</td>
             	</tr>
             	<tr>
             ...
             <tr>
               ...
               <td>
                 <input type="text" value="<s:property value="kaoyanStudent.GzfkTabStudyuniversity.FUniName"/>" disabled="disabled" name="GzfkTabStudyuniversity.FUniName">
               </td>
             </tr>
             <tr>
               <td align="center">国家</td>
               <td>
                 <input type="text" value="<s:property value="kaoyanStudent.FUniCountry"/>" name="FUniCountry">
               </td>
             </tr>
             <tr>
               <td align="center">深造专业</td>
               <td>
                 <input type="text" value="<s:property value="kaoyanStudent.FUniCity"/>" name="FKaoyanMajor">
               </td>
             </tr>
             ...
             <tr>
               ...
               <td>
                 <select name="FStudentDegre"  value="<s:property value="kaoyanStudent.FStudentDegre"/>">
