...
<html>
	...
	<body>
		...
		<h3 align="center">对不起，该学生去向记录已存在</h3>
		<table align="center" width="700">
			<tr>
				<th align="center"><a href="<%=basePath%>admin/OtherInfo!findAllOtherInfo.action"  ><img src="<%=basePath%>Pictures/return.gif" align="top" border="0"/>返回</a></th>
			</tr>
		</table>
