...
<html>
	...
	<body>
		...
		<h3 align="center">对不起，该用人单位信息已存在</h3>
		<table align="center" width="700">
			<tr>
				<th align="center"><a href="<%=basePath%>admin/CompanyInfo!findAllCompanyInfo.action" ><img src="<%=basePath%>Pictures/return.gif" align="top" border="0"/>返回</a></th>
			</tr>
		</table>
