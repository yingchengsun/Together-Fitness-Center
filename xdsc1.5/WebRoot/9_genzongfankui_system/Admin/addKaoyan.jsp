...
<html>
	...
	<body>
		<br>
		<h3 align="center"><h3 align="center"><img src="<%=basePath%>Pictures/submittutorial_001.png" align="top" border="0" width="50" height="50"/>添加深造学生信息</h3>
		<table align="center" width="700">
			<tr>
				<th align="left"><a href="<%=basePath%>admin/KaoyanInfo!findAllKaoyanInfo.action"><img src="<%=basePath%>Pictures/return.gif" align="top" border="0"/>返回</a></th>
			</tr>
		</table> 
		<hr>
		<div align="center">
			<form action="admin/KaoyanInfo!addKaoyanInfo.action" method="post">
				<table border="1" width="700">
					<tr>
						<th height="30" colspan="2" align="center" background="<%=basePath%>Pictures/newmenubg.gif">
							<font color="#FFFFFF">深造学生信息</font>
						</th>
					</tr>
					<tr>
						<td>
						...
						<td>
							<input type="text" name="FUniId"  /><a href="<%=basePath%>admin2/UniInfo!findAllUniInfo.action">
					...
					<tr>
						...
						<td>
							<input type="text" name="FKaoyanMajor"  />
						</td>
					</tr>
