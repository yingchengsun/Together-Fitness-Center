				...
				<div>
					...
					<div class="PI_main" style="height: 500px">
						<div style="position: relative;top: 5%;">
							...
							<div id="PARENT">
								<ul id="nav">
									<li><a href="<%=basePath%>student/StudentSelf!findStudentSelfInfo.action" target="right"> 基本信息</a></li>
									<li><a href="<%=basePath%>student/StudentQuxiang!StudentQuxiang.action" target="right"> 毕业信息</a></li>
								</ul>	
							</div>
							<div style="
								width:160px;
							...
							<div id="PARENT">
								<ul id="nav">
									<li><a href="<%=basePath%>9_genzongfankui_system/Student/selectGrade.jsp" target="right"> 毕业年级</a></li>
