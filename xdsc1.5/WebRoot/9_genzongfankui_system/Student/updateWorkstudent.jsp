...
<html>
	...
	<body>
		...
		<br>
		<h3 align="center">
			<img src="<%=basePath%>Pictures/sketchy_paper_001.png" align="top" border="0" width="50" height="50"/>修改就业信息
		</h3>
		<hr>
		<s:form action="student/WorkInfo!updateWorkInfo.action" method="post" theme="simple">
			<table border="0" id="mytable" width="700">
             ...
             <tr>
               ...
               <td>
                 <input type="text" value="<s:property value="workStudent.TabCompany.FCompanyName"/>"  name="TabCompany.FCompanyName">
               </td>
             </tr>
             <tr>
