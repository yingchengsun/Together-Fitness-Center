...
<html>
	...
	<body>
		...
		<br>
		<h3 align="center">
			<img src="<%=basePath%>Pictures/Aluminum_001.png" align="top" border="0" width="50" height="50"/>班级统计信息
		</h3>
		<hr>
		<s:form action="tutor/ClassInfo!findClassoneByNum.action" method="post" theme="simple" >
			...
			<table border="0" id="mytable" width="700">
				...
				<th>
				   ...
				   <tr>
				     ...
				     <td><a href="tutor/StudentInfo!findStudentByClass.action?FClassNumSelect=<s:property value="FClassNumber"/>">
  	...
  	<tr>
		<td><div align="center"><a href="<%=basePath %>tutor/ClassInfo!findAllClassInfo.action?p=1" >首页</a></div></td>
		<td><div align="center"><a href="<%=basePath %>tutor/ClassInfo!findAllClassInfo.action?p=${p-1}" >上一页</a></div></td>
		<td><div align="center"><a href="<%=basePath %>tutor/ClassInfo!findAllClassInfo.action?p=${p+1}" >下一页</a></div></td>
		<td><div align="center"><a href="<%=basePath %>tutor/ClassInfo!findAllClassInfo.action?p=${lastPage}" >末页</a></div></td>
	</tr>
  </table>
	</body>
</html>
