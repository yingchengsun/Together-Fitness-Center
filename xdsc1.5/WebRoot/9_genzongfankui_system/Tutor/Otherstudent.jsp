...
<html>
	...
	<br>
		<h3 align="center">
			<img src="<%=basePath%>Pictures/Aluminum_001.png" align="top" border="0" width="50" height="50"/>其他去向学生信息
		</h3>
			<br>
      <hr>
		<s:form action="tutor/OtherInfo!findOtherInfoByName.action" method="post" theme="simple">
  	...
  	<tr>
		<td><div align="center"><a href="<%=basePath %>tutor/OtherInfo!findAllOtherInfo.action?p=1" >首页</a></div></td>
		<td><div align="center"><a href="<%=basePath %>tutor/OtherInfo!findAllOtherInfo.action?p=${p-1}" >上一页</a></div></td>
		<td><div align="center"><a href="<%=basePath %>tutor/OtherInfo!findAllOtherInfo.action?p=${p+1}" >下一页</a></div></td>
		<td><div align="center"><a href="<%=basePath %>tutor/OtherInfo!findAllOtherInfo.action?p=${lastPage}" >末页</a></div></td>
	</tr>
  </table>
		<br>
		<br>
