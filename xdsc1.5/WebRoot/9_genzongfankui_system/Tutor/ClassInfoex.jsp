...
<html>
	...
	<body>
		...
		<br>
		<h3 align="center">
			<img src="<%=basePath%>Pictures/Aluminum_001.png" align="top" border="0" width="50" height="50"/>班级信息
		</h3>
		<hr>
			...
			<table border="0" id="mytable" width="700">
				<tr>
					<th align="center" colspan=12" background="<%=basePath%>Pictures/newmenubg.gif" height="30">
						<font color="#FFFFFF">软件学院班级基本信息</font>
					</th>
				</tr>
				<tr>
					<th>
				...
				<th>
				   ...
				   <tr>
				     ...
				     <td align="center"><s:property value="FClassPartyNum"/></td>
				     ...
				     <td>查看<a href="tutor/StudentInfo!findStudentByClass.action?FClassNumSelect=<s:property value="FClassNumber"/>">
