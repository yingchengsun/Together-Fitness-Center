						...
						<div >
							...
							<div class="subfun_list" id="subfun_list1" >
								<div style="background-Image: url(../images/funlist_bar3.gif);height:22px">
									<a href="" class="LINK21" target="mainFrame"> 功能1</a>
								</div>
								<div style="background-Image: url(../images/funlist_bar3.gif);height:22px">
									<a href="" class="LINK21" target="mainFrame"> 功能2</a>
								</div>
								<div style="background-Image: url(../images/funlist_bar3.gif);height:22px">
									<a href="" class="LINK21" target="mainFrame"> 功能3</a>
								</div>
								<div style="background-Image: url(../images/funlist_bar3.gif);height:22px">
									<a href="" class="LINK21" target="mainFrame"> 功能4</a>
								</div>
							</div>
							...
							<div style="background-Image: url(../images/funlist_bar3.gif);height:22px">
								...
								<div style="background-Image: url(../images/funlist_bar3.gif);height:22px">
									<a href="" class="LINK21" target="mainFrame"> 功能5</a>
								</div>
								<div style="background-Image: url(../images/funlist_bar3.gif);height:22px">
									<a href="" class="LINK21" target="mainFrame"> 功能6</a>
								</div>
							</div>
