...
<html>
  <head>
	...
	function addAddress(cid){
			//var address = document.getElementById(cid).value;
			var address = cid.value;
 ...
 <table>
  ...
  <form name="contact">
  	<c:forEach items="${contactList}" var="contact">
		...
		<!-- tr>
		<td id="${contact.FUserNumber }"
				onclick="addAddress();"
				onMouseOver="this.style.background='#c4e1ff'"
				onmouseout="this.style.background='white'">${contact.FUserNumber }@localhost</td>
		</tr-->
		<tr>
		<td><input type="text" value="${contact.FUserNumber }@localhost" name="addressbar" 
				readonly="readonly" 
