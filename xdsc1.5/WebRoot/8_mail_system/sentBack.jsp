...
<html>
  ...
  <body>
    ...
    background-color: #97cbff;">
   	<s:form action="<%=request.getContextPath() %>/8_mail_system/sendemail.action" method="post" enctype="multipart/form-data" >
    	<table >
    		<tr>
    			<td width="50" align="center"><input type="button" value="发送邮件" ></td>
    			<td width="50" align="center"><input type="button" value="存草稿" ></td>
    		</tr>
    	</table>
    	<div style="
    	position: absolute;
    	...
    	<table>
    		...
    		<tr>
    			<td>收件人</td><td><input type="text" name="mail.to" style="width: 527px" value="<%=request.getParameter("from") %>" readonly="readonly"></td>
    		</tr>
    		<tr>
    			<td>主 &nbsp; 题</td><td><input type="text" name="mail.subject" style="width: 527px"></td>
    		</tr>
    		<tr>
