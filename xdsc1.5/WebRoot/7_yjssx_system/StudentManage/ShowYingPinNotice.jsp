...
<div align="center" >
   ...
   <table width="100%" border="0" style="margin-top: 20px;background-image: url('<%=basePath %>7_yjssx_system/SubSystemImage/ddown01[1].gif')">
      <tr>
        <td width="100%" height="26"><div align="center">应聘信息</div></td>
      </tr>
   </table>
  ...
  <table width="100%"border="1" id="mytable" style="border-collapse:collapse" bordercolor="#999999" background="../SubSystemImage/bg.gif">
    ...
    <tr>
      ...
      <td><div align="center"><img src="<%=basePath %>7_yjssx_system/SubSystemImage/edit_profile.gif" height="15"/>
         <a href="<%=basePath %>yjssxStudent/PostgraduateYingPinInfo!showDetail.action?noticeId=${FInfoId }">查看详情</a> </div></td>
    </tr>
    </s:iterator>
   </s:else>
  </table>
  <table width="40%">
  	<tr>
		<td><div align="center"><a href="<%=basePath %>yjssxStudent/PostgraduateYingPinInfo!ShowNotice.action?p=1" >首页</a></div></td>
		<td><div align="center"><a href="<%=basePath %>yjssxStudent/PostgraduateYingPinInfo!ShowNotice.action?p=${p-1}" >上一页</a></div></td>
		<td><div align="center"><a href="<%=basePath %>yjssxStudent/PostgraduateYingPinInfo!ShowNotice.action?p=${p+1}" >下一页</a></div></td>
		<td><div align="center"><a href="<%=basePath %>yjssxStudent/PostgraduateYingPinInfo!ShowNotice.action?p=${lastPage}" >末页</a></div></td>
	</tr>
  </table>
