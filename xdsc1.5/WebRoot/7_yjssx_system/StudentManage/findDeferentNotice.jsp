...
<img src="<%=basePath %>7_yjssx_system/SubSystemImage/manage5.png" height="75"/>
  ...
  <form action="yjssxStudent/PostgraduateReceiveNotice!deleteNotice.action" method="post">
   <table width="100%" id="mytable" border="1" style="border-collapse:collapse" bordercolor="#999999" background="<%=basePath %>7_yjssx_system/SubSystemImage/bg.gif">
	  <tr style="background-image: url('<%=basePath %>7_yjssx_system/SubSystemImage/titlebg.gif')">
	    ...
	    <th scope="col"><div align="center">点击查看</div></th>
	  </tr>
	  <s:if test="noticeList.size==0">
	   ...
	   <s:iterator value="noticeList" status="status">
		  <tr>	  	
		    ...
		    <td><div align="center"><input type="checkbox" name="noticeId" value="${FInfoId }"/></div></td>
		    ...
		    <a href="<%=basePath %>yjssxStudent/PostgraduateReceiveNotice!showNoticeDetail.action?detailId=<s:property value="FInfoId"/>">查看</a></div></td>
		  </tr>
		</s:iterator>
		 <tr>
 ...
 <table width="40%">
  	<tr>
		<td><div align="center"><a href="<%=basePath %>yjssxStudent/PostgraduateReceiveNotice!findAllNotice.action?type=${type }&&p=1" >首页</a></div></td>
		<td><div align="center"><a href="<%=basePath %>yjssxStudent/PostgraduateReceiveNotice!findAllNotice.action?type=${type }&&p=${p-1}" >上一页</a></div></td>
		<td><div align="center"><a href="<%=basePath %>yjssxStudent/PostgraduateReceiveNotice!findAllNotice.action?type=${type }&&p=${p+1}" >下一页</a></div></td>
		<td><div align="center"><a href="<%=basePath %>yjssxStudent/PostgraduateReceiveNotice!findAllNotice.action?type=${type }&&p=${lastPage}" >末页</a></div></td>
	</tr>
  </table>
