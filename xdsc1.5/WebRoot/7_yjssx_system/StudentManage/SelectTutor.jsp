...
<script language="javascript">
	function opendialog(type)
		{	
			var tutorname=window.showModalDialog('<%=basePath %>yjssxStudent/PostgraduateAllTutorInfoForSelect!AllTutorInfo.action','title','scrollbars=no;resizable=no;help=no;status=no;dialogTop=100; dialogLeft=500;dialogHeight=350px;dialogwidth=450px;')
			var SubName="";
...
<div align="center">
   ...
   <table width="80%" border="0" style="margin-top: 100px;background-image: url('<%=basePath %>7_yjssx_system/SubSystemImage/ddown01[1].gif')">
      <tr>
        <td width="80%" height="26"><div align="center">选择导师</div></td>
      </tr>
   </table>
   <hr align="center" width="80%" size="2" color="#990033"/>
  <s:form action="PostgraduateSelectTutor!selectTutor.action" namespace="/yjssxStudent" id="form1" name="form1">
   <table width="80%"  border="1" style="border-collapse:collapse" bordercolor="#999999" background="../SubSystemImage/bg.gif"> 
     <tr>
       <td width="13%" height="57"><div align="left">第一志愿：</div></td>
       <td width="87%"><div align="left">
         <input name="tutorname1" type="text" onclick="opendialog(1)" value="请选择"  size="30"/>
     ...
     <tr>
       ...
       <td><div align="left">
         <input name="tutorname2" type="text" onclick="opendialog(2)" value="请选择"  size="30"/>
     ...
     <tr>
       ...
       <td><div align="left">
         <input name="tutorname3" type="text" onclick="opendialog(3)" value="请选择"  size="30"/>
