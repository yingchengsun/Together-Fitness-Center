...
<div align="center" >
   ...
   <table width="80%" border="0" style="margin-top: 100px;background-image: url('<%=basePath %>7_yjssx_system/SubSystemImage/ddown01[1].gif')">
      <tr>
        <td width="80%" height="26"><div align="center">${detailInfo.FInfoTitle }</div></td>
      </tr>
   </table>
   <table width="80%" >
   	  <tr>
  ...
  <table width="80%">
    <tr class="SubMenu" style="background-color:#CCCCCC">
       <td>
         <div align="right">发送日期:<fmt:formatDate value="${detailInfo.FInfoStartTime}" type="date" dateStyle="medium"/></div>
       </td >
    </tr>
    <tr>
      <td>
       <div align="center">${detailInfo.FInfoContet}</div>
       </td>
    </tr>
  </table>
