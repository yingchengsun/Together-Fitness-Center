			...
			<tr>
				<td>
					<iframe id="left" name="left" width="195px" height="620"
						src="<%=basePath%>7_yjssx_system/left_function_bar_forStu.jsp" scrolling="NO" frameborder="0"
						style="border-style: none; display: block"></iframe>
				</td>
				<td width="2%" valign="top">
					<iframe id="middleFrame" name="middleFrame" width="100%"
						height="620" src="<%=basePath%>7_yjssx_system/middleFrame.jsp" scrolling="yes" frameborder="0"
						style="border-style: none;"></iframe>
				</td>
				<td width="80%" valign="top">
					<iframe id="right" name="right" width="100%" height="620"
						src="<%=basePath%>7_yjssx_system/welcome_page_stu.jsp" scrolling="yes" frameborder="0"
						style="border-style: none;"></iframe>
				</td>
			</tr>
		</table>
