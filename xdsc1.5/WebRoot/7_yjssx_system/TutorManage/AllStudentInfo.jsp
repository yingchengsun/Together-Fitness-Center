...
<div align="center">
   ...
   <table width="100%" border="0" style="margin-top: 20px;background-image: url('<%=basePath %>7_yjssx_system/SubSystemImage/ddown01[1].gif')">
      <tr>
        <td width="100%" height="26"><div align="center">全部研究生信息</div></td>
      </tr>
   </table>
   <hr align="center" width="100%" />
	...
	<table width="40%">
  	<tr>
		<td><div align="center"><a href="<%=basePath %>yjssxTutor/TutorStuInfoForNotice!AllStudentInfo.action?p=1" >首页</a></div></td>
		<td><div align="center"><a href="<%=basePath %>yjssxTutor/TutorStuInfoForNotice!AllStudentInfo.action?p=${p-1}" >上一页</a></div></td>
		<td><div align="center"><a href="<%=basePath %>yjssxTutor/TutorStuInfoForNotice!AllStudentInfo.action?p=${p+1}" >下一页</a></div></td>
		<td><div align="center"><a href="<%=basePath %>yjssxTutor/TutorStuInfoForNotice!AllStudentInfo.action?p=${lastPage}" >末页</a></div></td>
	</tr>
  </table>
