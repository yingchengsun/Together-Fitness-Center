...
<div align="center" >
   ...
   <table width="100%" >
   	  <tr>
		   ...
		   <a href="<%=basePath %>yjssxTutor/TutorReceiveNotice!findAllNotice.action"><strong>返回</strong></a>
   	 	</td>
   	  </tr>
   </table>
  ...
  <table width="100%"border="1" style="border-collapse:collapse">
    <tr class="SubMenu" style="background-color:#CCCCCC">
        <td>
      <div align="right">发送日期:<fmt:formatDate value="${detailInfo.FInfoStartTime}" type="date" dateStyle="medium"/> </div></td >
    </tr>
    <tr>
      <td>
