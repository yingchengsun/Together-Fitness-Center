...
<div align="center">
   ...
   <table width="100%" id="mytable" border="1" style="border-collapse:collapse">
	 ...
	 <table width="40%">
  	<tr>
		<td><div align="center"><a href="<%=basePath %>yjssxTutor/TutorReceiveStudent!findAllDispachedStudent.action?p=1" >首页</a></div></td>
		<td><div align="center"><a href="<%=basePath %>yjssxTutor/TutorReceiveStudent!findAllDispachedStudent.action?p=${p-1}" >上一页</a></div></td>
		<td><div align="center"><a href="<%=basePath %>yjssxTutor/TutorReceiveStudent!findAllDispachedStudent.action?p=${p+1}" >下一页</a></div></td>
		<td><div align="center"><a href="<%=basePath %>yjssxTutor/TutorReceiveStudent!findAllDispachedStudent.action?p=${lastPage}" >末页</a></div></td>
	</tr>
  </table>
