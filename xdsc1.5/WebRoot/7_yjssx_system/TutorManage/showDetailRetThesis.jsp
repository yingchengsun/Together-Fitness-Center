...
<body background="<%=basePath %>7_yjssx_system/SubSystemImage/Background.png">
  ...
  <table width="100%" border="0" style="margin-top: 100px;background-image: url('<%=basePath %>7_yjssx_system/SubSystemImage/ddown01[1].gif')">
      <tr>
        <td width="100%"><div align="center"><s:property value="detailInfo.FThesisName"/></div></td>
      </tr>
   </table>
    ...
    <tr>
      ...
      <tr>
        <td><a href="<%=basePath %>files/7yjssx_system/infoFile/Thesis/${detailInfo.FThesisStorePath }">论文下载</a></td>
    </tr>
    </table>
  </div>
</body>
