...
<div align="center">
   ...
   <table width="100%" border="1" style="border-collapse:collapse" bordercolor="#999999" background="<%=basePath %>7_yjssx_system/SubSystemImage/bg.gif">
	  ...
	  <s:else>
	   <s:iterator value="submitThesisList" status="status">
		  <tr>
		    ...
		    <img src="<%=basePath %>7_yjssx_system/SubSystemImage/edit_profile.gif" height="15"/>
		      <a href="<%=basePath %>yjssxCommon/CommonOperation!findSubmitThesisDetail.action?SubmitThesisId=${FNumber }">查看详情</a></td>
		  </tr>
		</s:iterator>
	 </s:else>
  </table>
