...
<div align="center">
   ...
   <table width="100%" border="1" style="border-collapse:collapse" bordercolor="#999999" background="<%=basePath %>7_yjssx_system/SubSystemImage/bg.gif">
	  <tr style="background-image: url('<%=basePath %>7_yjssx_system/SubSystemImage/titlebg.gif')">
        ...
        <th><div align="center"><strong>名称</strong></div></th>
	    <th scope="col"><div align="center">反馈详情</div></th>
	    <th scope="col"><div align="center">审核状态</div></th>
	  </tr>
	  ...
	  <s:else>
	   <s:iterator value="returnThesisList" status="status">
		  <tr>
		    ...
		    <td align="center"><img src="<%=basePath %>7_yjssx_system/SubSystemImage/edit_profile.gif" height="15"/>
		      	<a href="<%=basePath %>yjssxCommon/CommonOperation!findReturnThesisDetail.action?ReturnThesisId=${FNumber }">查看详情</a></td>
		   <td><div align="center">
		    <img src="<%=basePath %>7_yjssx_system/SubSystemImage/edit_profile.gif" height="15"/>
		      <a href="#" onclick="openWindow('yjssxAdmin/AdminThesisManage!showDetailThesis.action?ThesisType=${ThesisType }&&DetailId=${FNumber }')">${FStatus }</a></div></td>
		  </tr>
		</s:iterator>
	 </s:else>
  </table>
