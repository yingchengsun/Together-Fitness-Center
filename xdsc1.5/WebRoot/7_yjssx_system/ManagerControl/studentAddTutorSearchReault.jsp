...
<div align="center">
  ...
  <form action="yjssxAdmin/AdminStudentInfoManage!confirmToAdd.action" method="post">
	<table width="100%" border="1" style="border-collapse:collapse">
	    ...
	    <s:if test="tutor.size==0">
			<tr>
				<td>对不起暂无数据！！！</td>
			</tr>
		</s:if>
	    <s:else>
	    <s:iterator value="tutor" status="status">
	    <tr>
	      <td align="center" height="24"><s:property value="#status.count" /></td>
	      <td><input type="checkbox" name="tutorId" value="${FTeacherNumber }"/></td>
