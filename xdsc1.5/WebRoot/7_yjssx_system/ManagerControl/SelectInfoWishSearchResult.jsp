...
<div align="center">
   ...
   <table width="100%" id="mytable" border="1" style="border-collapse:collapse" bordercolor="#999999"
	background="../SubSystemImage/bg.gif">
	    ...
	    <s:if test="tutorSelectInfo.size==0">
			<tr>
				<td>对不起暂无数据！！！</td>
			</tr>
		</s:if>
	   <s:else>
	    <s:iterator value="tutorSelectInfo" status="status">
	    <tr>
	      ...
	      <a href="<%=basePath %>yjssxCommon/CommonOperation!findStudentInfo.action?stuId=${tabPostgraduate.FStudentNumber}" class="STYLE5">研究生详情</a></div></td> 
	       <td align="center"><div align="center">
	       <img src="<%=basePath %>7_yjssx_system/SubSystemImage/edit_profile.gif" height="15"/>
	       <a href="<%=basePath %>yjssxStudent/PostgraduateSelectTutor!StudentSelectTutorInfo.action?StudenNum=${tabPostgraduate.FStudentNumber}" class="STYLE5">志愿详情</a></div></td>   
	    </tr>
	   </s:iterator>
	   </s:else>
	  </table>	 
	<table width="40%">
  	<tr>
		<td><div align="center"><a href="<%=basePath %>yjssxAdmin/AdminTutorSelectManage!SelectInfoWishSearch.action?wish=${wish }&&p=1" >首页</a></div></td>
		<td><div align="center"><a href="<%=basePath %>yjssxAdmin/AdminTutorSelectManage!SelectInfoWishSearch.action?wish=${wish }&&p=${p-1}" >上一页</a></div></td>
		<td><div align="center"><a href="<%=basePath %>yjssxAdmin/AdminTutorSelectManage!SelectInfoWishSearch.action?wish=${wish }&&p=${p+1}" >下一页</a></div></td>
		<td><div align="center"><a href="<%=basePath %>yjssxAdmin/AdminTutorSelectManage!SelectInfoWishSearch.action?wish=${wish }&&p=${lastPage}" >末页</a></div></td>
	</tr>
  </table>
