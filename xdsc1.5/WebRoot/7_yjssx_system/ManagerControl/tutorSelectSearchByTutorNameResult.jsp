...
<div align="center">
   ...
   <table width="80%" border="0" style="margin-top: 20px;background-image: url('<%=basePath %>7_yjssx_system/SubSystemImage/ddown01[1].gif')">
      <tr>
        <td width="80%" height="26"><div align="center">研究生导师选择</div></td>
      </tr>
   </table>
  ...
  <table width="80%" border="0">
   ...
   <table width="80%" border="1" id="mytable" style="border-collapse:collapse" bordercolor="#999999"
   ...
   <table width="80%"border="1" id="mytable1" style="border-collapse:collapse" bordercolor="#999999"
	background="../SubSystemImage/bg.gif">
	    <tr style="background-image: url('<%=basePath %>7_yjssx_system/SubSystemImage/titlebg.gif')">
	      <th>编号</th>
	      <th><div align="center"><strong>研究生名称</strong></div></th>
   ...
   <table width="80%"border="1" id="mytable2" style="border-collapse:collapse" bordercolor="#999999"
	background="../SubSystemImage/bg.gif">
	    <tr style="background-image: url('<%=basePath %>7_yjssx_system/SubSystemImage/titlebg.gif')">
	      <th>编号</th>
	      <th><div align="center"><strong>研究生名称</strong></div></th>
