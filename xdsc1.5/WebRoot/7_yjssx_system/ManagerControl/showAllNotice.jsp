...
<div align="center">
 ...
 <form action="yjssxAdmin/AdminNoticeOperation!deleteNotice.action" method="post">
		   ...
		   <s:iterator value="noticeList" status="status">
			  <tr>
			    <td align="center" height="24"><s:property value="#status.count" /></td>
			  	<td><div align="center"><input type="checkbox" name="delId" value="${FInfoId }"/></div></td>
			    ...
			    <a href="<%=basePath %>yjssxAdmin/AdminNoticeOperation!showNoticeDetail.action?noticeId=<s:property value="FInfoId"/>">查看</a></div></td>
			  </tr>
			</s:iterator>
 ...
 <table width="40%">
  	<tr>
		<td><div align="center"><a href="<%=basePath %>yjssxAdmin/AdminNoticeOperation!showAllNotice.action?p=1" >首页</a></div></td>
		<td><div align="center"><a href="<%=basePath %>yjssxAdmin/AdminNoticeOperation!showAllNotice.action?p=${p-1}" >上一页</a></div></td>
		<td><div align="center"><a href="<%=basePath %>yjssxAdmin/AdminNoticeOperation!showAllNotice.action?p=${p+1}" >下一页</a></div></td>
		<td><div align="center"><a href="<%=basePath %>yjssxAdmin/AdminNoticeOperation!showAllNotice.action?p=${lastPage}" >末页</a></div></td>
	</tr>
  </table>
