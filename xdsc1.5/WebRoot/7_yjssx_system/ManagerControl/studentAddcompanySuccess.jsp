	...
	<table width="80%" height="69" border="1" style="border-collapse:collapse" bordercolor="#999999"
	   background="../SubSystemImage/bg.gif">
	    <tr style="background-color:#CCCCCC">
	      <td width="139"><div align="center"><strong>企业名称</strong></div></td>
	      <td width="139"><div align="center"><strong>企业电话</strong></div></td>
	      <td width="139"><div align="center"><strong>企业邮箱</strong></div></td>
	      <td width="139"><div align="center"><strong>新增研究生姓名</strong></div></td>
	      <td width="216"><div align="center"><strong>查看详情</strong></div></td>
	    </tr>
	    <tr>
	      <td align="center"><img src="<%=basePath %>7_yjssx_system/SubSystemImage/xuesheng.gif" />&nbsp;${comInfo.FCompanyName }</td>
	      <td align="center"><img src="<%=basePath %>7_yjssx_system/SubSystemImage/xuesheng.gif" />&nbsp;${comInfo.FTelephone }</td>
	       <td>${comInfo.FEmailAddress }"</td>
	      ...
	      <a href="<%=basePath %>yjssxCommon/CommonOperation!findCompanyInfo.action?comId=${comInfo.FCompanyNumber}" class="STYLE5">点击查看基本信息</a></div></td>    
	    </tr>
	</table>
	<p align="center">	
	...
	<table width="80%" height="69" border="1" style="border-collapse:collapse" bordercolor="#999999"
	   background="../SubSystemImage/bg.gif">
	     <tr style="background-color:#CCCCCC">
	      ...
	      <td width="139"><div align="center"><strong>邮箱</strong></div></td>
	      <td width="139"><div align="center"><strong>所在企业</strong></div></td>
	      <td width="216"><div align="center"><strong>查看详情</strong></div></td>
	    </tr>
	    <tr>
	      ...
	      <td>${studentInfo.tabStudents.FStudentEmail  }</td>
	      <td>${comInfo.FCompanyName }</td>
	      <td align="center"><div align="center">
	      <img src="<%=basePath %>7_yjssx_system/SubSystemImage/edit_profile.gif" height="15"/>
