...
<img src="<%=basePath %>7_yjssx_system/SubSystemImage/clock.png" height="70" />
   ...
   <hr align="center" width="100%"/>
   <form action="yjssxAdmin/AdminSystemFunctionDeploy!OpenSbTutorSelect.action" method="post">
	...
	background="<%=basePath %>7_yjssx_system/SubSystemImage/bg.gif">
	    <tr style="background-image: url('<%=basePath %>7_yjssx_system/SubSystemImage/titlebg.gif')">
	      <th>编号</th>
	   ...
	   <tr style="background-color:#CCCCCC">
	      ...
	      <td ><div align="center"></div></td>
	      <td ><div align="center"><input type="submit" value="开通此功能" /></div></td>
	      <td></td>
	      <td></td>
	    </tr>
	    </s:else>
