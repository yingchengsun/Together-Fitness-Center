			...
			<tr>
				<td>
					<iframe id="left" name="left" width="195px" height="620"
						src="<%=basePath%>7_yjssx_system/left_function_bar_forTutor.jsp" scrolling="NO" frameborder="0"
				...
				<td width="80%" valign="top">
					<iframe id="right" name="right" width="100%" height="620"
						src="<%=basePath%>7_yjssx_system/welcome_page_tutor.jsp" scrolling="NO" frameborder="0"
						style="border-style: none;"></iframe>
				</td>
			</tr>
		</table>
