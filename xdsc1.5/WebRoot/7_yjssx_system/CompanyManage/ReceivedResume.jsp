...
<div align="center">
   ...
   <table width="100%" border="0" style="margin-top: 20px;background-image: url('<%=basePath %>7_yjssx_system/SubSystemImage/ddown01[1].gif')">
      <tr>
        <td width="100%" height="26"><div align="center">查收研究生简历</div></td>
      </tr>
   </table>
  ...
  <form action="yjssxCompany/CompanyNoticeToStudent!NoticeToStudent.action" method="post">
	 <table width="100%" border="1"  id="mytable" style="border-collapse:collapse">
	    <tr style="background-image: url('<%=basePath %>7_yjssx_system/SubSystemImage/titlebg.gif')">
	      ...
	      <th ><div align="center"><strong>简历下载</strong></div></th>
	      <th ><div align="center"><strong>查看详情</strong></div></th>
	      <th><div align="center"><strong>删除</strong></div></th>
	    </tr>
	    ...
	    <tr>
	      ...
	      <td><div align="center"><input type="checkbox" name="NoticeStuId" value="${tabPostgraduate.FStudentNumber }"/></div></td>
	      ...
	      <td align="center"><a href="<%=basePath %>files/7yjssx_system/infoFile/uploadResume/${FFilePath }">${tabPostgraduate.tabStudents.FStudentName }简历</a>&nbsp;<img src="<%=basePath %>7_yjssx_system/SubSystemImage/gif-0145.gif" /></td>
	      <td align="center"><div align="center">
	      <img src="<%=basePath %>7_yjssx_system/SubSystemImage/edit_profile.gif" height="15"/>
	      <a href="<%=basePath %>yjssxCommon/CommonOperation!findStudentInfo.action?stuId=${tabPostgraduate.FStudentNumber}" class="STYLE5">点击查看详细信息</a></div></td>
	      <td align="center"><div align="center"><a href="<%=basePath %>yjssxCompany/CompanyCheckResume!deleteResume.action?resumeId=${FNumber}" class="STYLE5">删除</a></div></td>     
	    </tr>
	   </s:iterator>
	   <tr>
   ...
   <table width="40%">
  	<tr>
		<td><div align="center"><a href="<%=basePath %>yjssxCompany/CompanyCheckResume!receiveResume.action?p=1" >首页</a></div></td>
		<td><div align="center"><a href="<%=basePath %>yjssxCompany/CompanyCheckResume!receiveResume.action?p=${p-1}" >上一页</a></div></td>
		<td><div align="center"><a href="<%=basePath %>yjssxCompany/CompanyCheckResume!receiveResume.action?p=${p+1}" >下一页</a></div></td>
		<td><div align="center"><a href="<%=basePath %>yjssxCompany/CompanyCheckResume!receiveResume.action?p=${lastPage}" >末页</a></div></td>
	</tr>
  </table>
