...
<div align="center" >
   ...
   <table width="100%" >
   	  <tr>
		   ...
		   <a href="<%=basePath %>yjssxCompany/CompanyReceiveNotice!findAllNotice.action"><strong>返回</strong></a>
   	 	</td>
   	  </tr>
   </table>
  ...
  <table width="100%"border="1" style="border-collapse:collapse" bordercolor="#999999" background="../SubSystemImage/bg.gif">
    <tr class="SubMenu" style="background-color:#CCCCCC">
        <td align="right">
           发送日期:<fmt:formatDate value="${detailInfo.FInfoStartTime}" type="date" dateStyle="medium"/>
        </td >
    </tr>
    <tr>
     <td>
