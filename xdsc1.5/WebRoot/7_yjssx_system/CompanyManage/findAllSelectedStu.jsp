...
<div align="center">
  ...
  <form action="yjssxCompany/CompanySelectedStudent!sendPracticeNotice.action" method="post">
	...
	background="../SubSystemImage/bg.gif">
	    ...
	    <s:if test="acceptedStuList.size==0">
			<tr>
				<td colspan="12" align="left">对不起暂无数据！！！</td>
			</tr>
		</s:if>
	    <s:else>
   ...
   <table width="40%">
  	<tr>
		<td><div align="center"><a href="<%=basePath %>yjssxCompany/CompanySelectedStudent!showSelectedStu.action?p=1" >首页</a></div></td>
		<td><div align="center"><a href="<%=basePath %>yjssxCompany/CompanySelectedStudent!showSelectedStu.action?p=${p-1}" >上一页</a></div></td>
		<td><div align="center"><a href="<%=basePath %>yjssxCompany/CompanySelectedStudent!showSelectedStu.action?p=${p+1}" >下一页</a></div></td>
		<td><div align="center"><a href="<%=basePath %>yjssxCompany/CompanySelectedStudent!showSelectedStu.action?p=${lastPage}" >末页</a></div></td>
	</tr>
  </table>
