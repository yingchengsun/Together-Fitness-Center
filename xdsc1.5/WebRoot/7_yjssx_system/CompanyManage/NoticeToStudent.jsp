...
<body background="../SubSystemImage/Background.png">
   ...
   <table width="90%" border="0" style="margin-top: 20px;background-image: url('<%=basePath %>7_yjssx_system/SubSystemImage/ddown01[1].gif')">
      <tr>
        <td width="90%" height="26"><div align="center">发送应聘通知</div></td>
      </tr>
   </table>
   <table width="90%" id="mytable" border="1" style="border-collapse:collapse">
	  ...
	  <form action="yjssxCompany/CompanyNoticeToStudent!saveNotice.action"  method="post" enctype="multipart/form-data">
	      ...
	      <table width="90%" height="418" border="1" style="border-collapse:collapse" bordercolor="#999999">
	        <tr>
	          <td height="55"><div align="left">标题：&nbsp;</div></td>
	          <td ><div align="left">
	        ...
	        <tr>
	          <td width="134" height="55"><div align="left">相关资料：&nbsp;</div></td>
	          <td width="606" colspan="3"><div align="left">
