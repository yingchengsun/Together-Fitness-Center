...
<div align="center">
    <img src="<%=basePath %>7_yjssx_system/SubSystemImage/manage3.png" height="80" />
  ...
  <form action="yjssxCompany/CompanyReceiveNotice!deleteNotice.action" method="post">
	  ...
	  <s:else>
	   <s:iterator value="noticeList" status="status">
		  <tr>
		    ...
		    <a href="<%=basePath %>yjssxCompany/CompanyReceiveNotice!showNoticeDetail.action?detailId=<s:property value="FInfoId"/>">查看</a></div></td>
		  </tr>
		</s:iterator>
 ...
 <table width="40%">
  	<tr>
		<td><div align="center"><a href="<%=basePath %>yjssxCompany/CompanyReceiveNotice!findAllNotice.action?p=1" >首页</a></div></td>
		<td><div align="center"><a href="<%=basePath %>yjssxCompany/CompanyReceiveNotice!findAllNotice.action?p=${p-1}" >上一页</a></div></td>
		<td><div align="center"><a href="<%=basePath %>yjssxCompany/CompanyReceiveNotice!findAllNotice.action?p=${p+1}" >下一页</a></div></td>
		<td><div align="center"><a href="<%=basePath %>yjssxCompany/CompanyReceiveNotice!findAllNotice.action?p=${lastPage}" >末页</a></div></td>
	</tr>
  </table>
