...
<html>
	...
	<body>
		...
		<table align="center" width="98%">
			<tr>
				<th align="left">
					<a href="<%=request.getContextPath()%>/getMyProjectList.action"><img
				...
				<tr>
					...
					<td colspan="4">
						<c:forEach items="${memberList }" var="member">
							<a
								href="<%=request.getContextPath()%>/showStudentDiary.action?id=${member.tabStudents.FStudentNumber }"><img
									src="<%=request.getContextPath()%>/bksx/pictures/male.png"
