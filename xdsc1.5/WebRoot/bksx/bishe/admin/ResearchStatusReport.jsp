...
<html>
	...
	<body>
		...
		<h3 align="center">
			<img
				src="<%=request.getContextPath()%>/bksx/pictures/3dicon_001.png"
			...
			<c:if test="${not empty summary }">
				<table border="1" cellspacing="0" width="98%">
					...
					<tr>
						...
						<td>
							${summary.bksxTabSubstugui.FStudentName }
						</td>
					</tr>
					...
					<tr>
						...
						<td>
							<form
								action="<%=request.getContextPath()%>/addManagerAdvice2Summary.action?id=${summary.FWid }"
								method="post">
