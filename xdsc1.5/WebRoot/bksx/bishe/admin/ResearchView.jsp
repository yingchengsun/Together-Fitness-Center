...
<html>
	...
	<body>
		...
		<table align="center" width="98%">
			<tr>
				<th align="left">
					<a href="<%=request.getContextPath()%>/getResearchSubject.action"><img
		...
		<div align="center">
			<table border="1" cellspacing="0" width="98%" id="mytable">
				...
				<tr>
					<td colspan="5">
						<a
							href="<%=request.getContextPath()%>/showStudentDiary.action?id=${substugui.tabStudents.FStudentNumber }"><img
								src="<%=request.getContextPath()%>/bksx/pictures/blog.gif"
								align="top" border="0"/>检查个人工作</a>
					</td>
				</tr>
			</table>
			<br>
				...
				<c:if test="${not empty searchplan }">
					<table width="98%" border="1" cellspacing="0">
						...
						<tr>
							...
							<td>
								${searchplan.bksxTabSubstugui.FStudentName }
							</td>
						</tr>
						<tr>
							<td colspan="2">
