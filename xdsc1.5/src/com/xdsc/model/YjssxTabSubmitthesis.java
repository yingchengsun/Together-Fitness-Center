...
/**
 * YjssxTabSubmitthesis entity.
 * 
 * @author MyEclipse Persistence Tools
 */

public class YjssxTabSubmitthesis implements java.io.Serializable {
	...
	/** default constructor */
	public YjssxTabSubmitthesis() {
	}

	/** full constructor */
	public YjssxTabSubmitthesis(TabTeachers tabTeachers,
			TabPostgraduate tabPostgraduate, String FThesisName,
			String FComment, String FThesisStorePath, Date FDate,
			String FThesisType, String FStatus, String FReason) {
