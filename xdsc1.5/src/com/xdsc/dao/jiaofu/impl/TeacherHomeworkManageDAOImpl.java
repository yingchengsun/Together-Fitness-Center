...
public class TeacherHomeworkManageDAOImpl extends HibernateDaoSupport implements TeacherHomeworkManageDAO{
	...
	/**
	 * <p>功能：选择新提交的作业数量<br>
	 * @param FUserNumber 用户编号
	 * @return list.get(0) 作业数量
	 */
...
//					if(listUsualscore.get(j).getFType().equals("平时考勤")){
//						TKscore = TKscore + listUsualscore.get(j).getFScore();
//					}else if(listUsualscore.get(j).getFType().equals("平时作业")){
